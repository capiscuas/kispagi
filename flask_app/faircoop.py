areas = [
    ...
    {'id': 'techarea', 'name': 'Tech Area', 'gitlab': 28, 'ocp': [475], 'redmine': ['tech-area', 'redmine', 'fair-coop-website',
                                                                                    'faircoop-forum', 'manual-redmine']},
    {'id': 'fairmarket', 'name': 'FairMarket', 'gitlab': 16, 'ocp': [512], 'redmine': ['fairmarket']},
    {'id': 'ocpdev', 'name': 'OCP/Agent Development',  'ocp': [547, 18]},
